...
form.addEventListener('submit', async (e) => {
    ...
    if (sender_length > 0 && receiver_length > 0 && sender_current_balance > form.amount.value && form.sender.value !== form.receiver.value && form.amount.value > 0) {
...
db.collection('Transfers').orderBy("timeSnap").get().then((snapshot) => {
